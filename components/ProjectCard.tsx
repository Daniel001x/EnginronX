        ...
        <div className="flex shrink-0 gap-2">
          ...
          {project.liveUrl && (
            <Link
              ...
              className={cn(
                "rounded-lg border border-zinc-300 bg-white p-2 text-zinc-700 transition hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:bg-zinc-800",
              )}
